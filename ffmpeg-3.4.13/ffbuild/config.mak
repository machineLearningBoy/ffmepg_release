...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--prefix='G:/ffmpeg' --enable-gpl --enable-libx264 --disable-static --disable-htmlpages --enable-muxer=rtsp --enable-demuxer=rtsp --enable-protocol=rtmp --enable-protocol=rtsp --enable-protocol=http --enable-shared --enable-sdl2 --enable-ffplay --enable-ffprobe --enable-ffmpeg --enable-avresample --extra-cflags='-IG:/x264-build/include' --extra-ldflags='-LG:\x264-build\lib'
prefix=G:/ffmpeg
...
CC_IDENT=gcc 14.2.0 (Rev2, Built by MSYS2 project)
ARCH=x86
INTRINSICS=none
CC=gcc
CXX=g++
...
CFLAGS=  -IG:/x264-build/include -std=c11 -fomit-frame-pointer -IG:/SDL2-2.0.22/x86_64-w64-mingw32/include/SDL2 -g -Wdeclaration-after-statement -Wall -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -Wno-pointer-to-int-cast -Wstrict-prototypes -Wempty-body -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wno-pointer-sign -Wno-unused-const-variable -Wno-bool-operation -O3 -fno-math-errno -fno-signed-zeros -fno-tree-vectorize -Werror=format-security -Werror=implicit-function-declaration -Werror=missing-prototypes -Werror=return-type -Werror=vla -Wformat -fdiagnostics-color=auto -Wno-maybe-uninitialized
CXXFLAGS=  -D__STDC_CONSTANT_MACROS -std=c++11
OBJCFLAGS=  
ASFLAGS=  -IG:/x264-build/include -fPIC -g
...
DEPWINDRES=gcc
DOXYGEN=doxygen
LDFLAGS= -LG:\x264-build\lib  -Wl,--nxcompat,--dynamicbase -Wl,--high-entropy-va -Wl,--as-needed -Wl,--warn-common -Wl,-rpath-link=libpostproc:libswresample:libswscale:libavfilter:libavdevice:libavformat:libavcodec:libavutil:libavresample
LDEXEFLAGS= -Wl,--image-base,0x140000000
LDLIBFLAGS=
SHFLAGS=-shared -Wl,--output-def,$$(@:$(SLIBSUF)=.orig.def) -Wl,--out-implib,$(SUBDIR)lib$(SLIBNAME:$(SLIBSUF)=.dll.a) -Wl,--enable-runtime-pseudo-reloc -Wl,--disable-auto-image-base -Wl,--image-base,0x180000000 -Wl,-Bsymbolic -Wl,--version-script,$(SUBDIR)lib$(NAME).ver
ASMSTRIPFLAGS= -x
...
CFLAGS-ffplay=-IG:/SDL2-2.0.22/x86_64-w64-mingw32/include/SDL2 -Dmain=SDL_main
CFLAGS_HEADERS= -Wno-deprecated-declarations -Wno-unused-variable
ZLIB=-lz
LIB_INSTALL_EXTRA_CMD=$$(RANLIB) "$(LIBDIR)/$(LIBNAME)"
EXTRALIBS=-lgdi32 -lpsapi -lole32 -lstrmiids -luuid -loleaut32 -lshlwapi -LG:/SDL2-2.0.22/x86_64-w64-mingw32/lib -lmingw32 -lSDL2main -lSDL2  -luser32 -LG:/SDL2-2.0.22/x86_64-w64-mingw32/lib -lmingw32 -lSDL2main -lSDL2 -lws2_32 -liconv -lvfw32 -luser32 -lsecur32 -LG:/SDL2-2.0.22/x86_64-w64-mingw32/lib -lmingw32 -lSDL2main -lSDL2 -lx264 -lm -llzma -lbz2 -lz -lpsapi -ladvapi32 -lshell32 -lole32 
COMPAT_OBJS=
INSTALL=install
...
EXTRALIBS-ffplay=-LG:/SDL2-2.0.22/x86_64-w64-mingw32/lib -lmingw32 -lSDL2main -lSDL2
EXTRALIBS-ffprobe=
EXTRALIBS-ffserver=
EXTRALIBS-ffmpeg=
!ARCH_AARCH64=yes
