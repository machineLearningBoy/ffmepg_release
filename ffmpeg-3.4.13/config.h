...
#define FFMPEG_CONFIGURATION "--prefix='G:/ffmpeg' --enable-gpl --enable-libx264 --disable-static --disable-htmlpages --enable-muxer=rtsp --enable-demuxer=rtsp --enable-protocol=rtmp --enable-protocol=rtsp --enable-protocol=http --enable-shared --enable-sdl2 --enable-ffplay --enable-ffprobe --enable-ffmpeg --enable-avresample --extra-cflags='-IG:/x264-build/include' --extra-ldflags='-LG:\\x264-build\\lib'"
#define FFMPEG_LICENSE "GPL version 2 or later"
#define CONFIG_THIS_YEAR 2023
#define FFMPEG_DATADIR "G:/ffmpeg/share/ffmpeg"
#define AVCONV_DATADIR "G:/ffmpeg/share/ffmpeg"
